...
import { traceMessageRoute } from "../otel-instrumentation.js";
...
export function resolveAgentRoute(input: ResolveAgentRouteInput): ResolvedAgentRoute {
  ...
  const choose = (agentId: string, matchedBy: ResolvedAgentRoute["matchedBy"]) => {
    ...
    // Record routing decision in OpenTelemetry
    traceMessageRoute(channel, sessionKey, resolvedAgentId, matchedBy);
